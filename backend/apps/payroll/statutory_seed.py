...
PROFESSIONAL_TAX_RULES = [
    ...
    },
    {
        ...
        'source_label': 'Gujarat PT salary-earner schedule',
        'source_url': 'https://www.commercialtax.gujarat.gov.in/',
        'notes': 'Flat salary-earner levy with the standard annual cap of Rs. 2,400.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '11999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '12000.00', 'max_income': None, 'deduction_amount': '200.00'},
        ],
    },
    {
        'country_code': 'IN',
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Haryana PT salary-earner schedule',
        'source_url': 'https://haryanatax.gov.in/',
        'notes': 'Haryana PT is district-administered; this seed covers the commonly-applied salary threshold.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '24999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '25000.00', 'max_income': None, 'deduction_amount': '200.00'},
        ],
    },
    {
        'country_code': 'IN',
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Punjab PT salary-earner schedule',
        'source_url': 'https://etax.punjab.gov.in/',
        'notes': 'Female employees remain exempt in the seeded salary-earner slabs.',
        'slabs': [
            {'gender': ProfessionalTaxGender.FEMALE, 'min_income': '0.00', 'max_income': None, 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.MALE, 'min_income': '0.00', 'max_income': '20833.00', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.MALE, 'min_income': '20833.01', 'max_income': None, 'deduction_amount': '200.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '20833.00', 'deduction_amount': '0.00'},
        ],
    },
    {
        'country_code': 'IN',
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Odisha PT salary-earner schedule',
        'source_url': 'https://odishatax.gov.in/',
        'notes': 'Seeded using the GST subdivision code OD used across the platform.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '24999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '25000.00', 'max_income': None, 'deduction_amount': '200.00'},
        ],
    },
    {
        ...
        'source_label': 'Rajasthan PT abolished sentinel',
        'source_url': 'https://finance.rajasthan.gov.in/',
        'notes': 'Explicit no-PT sentinel so payroll runs in Rajasthan resolve to zero instead of erroring.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': None, 'deduction_amount': '0.00'},
        ],
    },
    {
        'country_code': 'IN',
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Himachal Pradesh PT salary-earner schedule',
        'source_url': 'https://himcomtax.nic.in/',
        'notes': 'Salary-earner threshold seed for Himachal Pradesh.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '9999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '10000.00', 'max_income': None, 'deduction_amount': '200.00'},
        ],
    },
    {
        'country_code': 'IN',
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Chhattisgarh PT salary-earner schedule',
        'source_url': 'https://comtax.cg.nic.in/',
        'notes': 'Seeded using the GST subdivision code CT used across the platform.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '24999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '25000.00', 'max_income': None, 'deduction_amount': '200.00'},
        ],
    },
    {
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 4, 1),
        'source_label': 'Jharkhand PT salary-earner schedule',
        'source_url': 'https://comtax.jharkhand.gov.in/',
        'notes': 'Two-step salary-earner slab retained for threshold coverage.',
        'slabs': [
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '0.00', 'max_income': '24999.99', 'deduction_amount': '0.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '25000.00', 'max_income': '41666.00', 'deduction_amount': '100.00'},
            {'gender': ProfessionalTaxGender.ANY, 'min_income': '41666.01', 'max_income': None, 'deduction_amount': '150.00'},
        ],
    },
]
...
LABOUR_WELFARE_FUND_RULES = [
    ...
    },
    {
        ...
        'source_label': 'Andhra Pradesh Labour Welfare Fund annual contribution',
        'source_url': 'https://labour.ap.gov.in/',
        'notes': 'Annual contribution collected in December.',
        'contributions': [
            {
                'min_wage': None,
                'max_wage': None,
                'employee_amount': '40.00',
                'employer_amount': '60.00',
                'applicable_months': [12],
            },
        ],
    },
    {
        ...
        'deduction_frequency': StatutoryDeductionFrequency.ANNUAL,
        'effective_from': date(2018, 1, 1),
        'source_label': 'Telangana Labour Welfare Fund annual contribution',
        'source_url': 'https://labour.telangana.gov.in/',
        'notes': 'Annual contribution collected in December.',
        'contributions': [
            {
                'min_wage': None,
    ...
    },
    {
        ...
        'deduction_frequency': StatutoryDeductionFrequency.ANNUAL,
        'effective_from': date(2018, 1, 1),
        'source_label': 'Madhya Pradesh Labour Welfare Fund annual contribution',
        'source_url': 'https://labour.mp.gov.in/',
        'notes': 'Annual contribution collected in December for monthly wages up to Rs. 10,000.',
        'contributions': [
            {
                'min_wage': '0.00',
                'max_wage': '10000.00',
    ...
    },
    {
        ...
        'deduction_frequency': StatutoryDeductionFrequency.MONTHLY,
        'effective_from': date(2018, 1, 1),
        'source_label': 'Haryana Labour Welfare Fund daily-rate equivalent',
        'source_url': 'https://hrylabour.gov.in/',
        'notes': 'Daily rates are represented as a 30-day payroll-month equivalent.',
        'contributions': [
            {
                'min_wage': None,
                'max_wage': None,
                'employee_amount': '7.50',
                'employer_amount': '22.50',
                'applicable_months': [],
            },
        ],
    },
    {
        ...
        'deduction_frequency': StatutoryDeductionFrequency.ANNUAL,
        'effective_from': date(2018, 1, 1),
        'source_label': 'Odisha Labour Welfare Fund annual contribution',
        'source_url': 'https://labour.odisha.gov.in/',
        'notes': 'Annual contribution collected in December using the GST subdivision code OD.',
        'contributions': [
            {
                'min_wage': None,
                'max_wage': None,
