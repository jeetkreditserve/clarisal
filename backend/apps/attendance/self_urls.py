...
urlpatterns = [
    ...
    path('attendance/regularizations/', MyAttendanceRegularizationListView.as_view(), name='my-attendance-regularization-list'),
    path('attendance/regularizations/<uuid:pk>/', MyAttendanceRegularizationDetailView.as_view(), name='my-attendance-regularization-detail'),
    path('attendance/regularizations/<uuid:pk>/withdraw/', MyAttendanceRegularizationWithdrawView.as_view(), name='my-attendance-regularization-withdraw'),
]
