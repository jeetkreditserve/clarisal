...
export function ApprovalsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="Approvals" title="Requests needing my action" description="Approve or reject active HR requests routed to you by the organisation workflow engine." />
